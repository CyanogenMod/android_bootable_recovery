...
ifeq ($(BOARD_EMMC_PATH),)
BOARD_EMMC_PATH := /emmc
endif

ifeq ($(BOARD_EXTSDCARD_PATH),)
BOARD_EXTSDCARD_PATH := /extsdcard
endif

BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY BOARD_EMMC_PATH BOARD_EXTSDCARD_PATH
