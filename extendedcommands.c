...
MFMatrix get_mnt_fmt_capabilities(char *vfs, char *vpath) {
    MFMatrix mfm = { vpath, 1, 1 };
    ...
    custom_path = strtok(custom_forbidden_mount, ",");
    ...
    custom_path = strtok(custom_forbidden_format, ",");
    while (custom_path != NULL) {
        if (strcmp(vpath, custom_path) == 0) {
            mfm.can_format = 0;
        }
