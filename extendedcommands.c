...
int show_nandroid_menu()
{
    ...
    memset(list, 0, ((MAX_NUM_MANAGED_VOLUMES + 1) * 4) + 2);
    ...
    for (;;) {
        ...
        if (chosen_item == max_backup_index) {
            ...
            if (chosen_item > 4) {
                ...
                chosen_path = extra_paths[chosen_item / 4];
            }
            ...
            case 0:
                {
                    ...
                    if (tmp == NULL)
                    {
                        ...
                        sprintf(backup_path, "%s/clockworkmod/backup/%d", chosen_path, tp.tv_sec);
                    }
                    else
                    {
